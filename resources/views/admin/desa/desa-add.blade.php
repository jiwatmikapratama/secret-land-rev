                                ...
                                <div class="card-body">
                                    <form method="POST" action="dashboard" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="fk_id_kabupaten" class="form-control" name="fk_id_kabupaten"
                                                required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" class="form-control" cols="30" rows="10" required>{{ old('deskripsi') }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
