                ...
                <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
                    ...
                    <div class="row" data-aos="fade-up">
                        @foreach ($KategoriList as $kategori)
                            <div class="col">
                                <button class="btn tombol"><a
                                        href="/beranda-kategori-wisata/{{ $kategori->id }}">{{ $kategori->nama }}</a></button>
                            </div>
                        @endforeach
                                ...
                                <a href="beranda-detail/{{ $wisata->id }}">
                                    <div class="card2">
                                        ...
                                        <div class="card-body2">
                                            <h5 class="card-titlet" style="font-weight:bold;">Wisata {{ $wisata->nama }}
                                            </h5>
                                            <h5 style="font-size:15px;">Desa {{ $wisata->desa->nama }}</h5>
            ...
            <section id="contact" class="contact">
                ...
                <d<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-md-5 mt-5">
                        <a href="/beranda/daftar-wisata" class="button rounded-pill shadow tebel-sedang">DAFTAR WISATA YANG
                            BELUM
                            ADA</a>
                    </div>
                    <div class="col-md-5 mt-5">
                        <a href="/beranda/daftar-desa" class="button rounded-pill shadow tebel-sedang">DAFTAR DESA YANG
                            BELUM
                            ADA</a>
                    </div>
        </div>
