                                ...
                                <a href="beranda-detail/{{ $wisata->id }}">
                                    <div class="card2">
                                        ...
                                        <div class="card-body2">
                                            <h5 class="card-titlet" style="font-weight:bold;">Wisata {{ $wisata->nama }}</h5>
                                ...
                                <a href="beranda-detail/{{ $desa->id }}">
                                    <div class="card2">
                                        <img src="{{ asset('daerah/' . $desa->gambar) }}" class="card-image2"
                                            alt="...">
                                        <div class="card-body2">
                                            <h5 class="card-titlet" style="font-weight:bold;">Desa {{ $desa->nama }}</h5>
                                            <h5 style="font-size:15px;">Kab. {{ $desa->kabupaten->nama }}</h5>
                                            {{-- <p class="card-text">{{ Str::of($wisata->deskripsi)->limit(20) }}</p> --}}
                                        </div>
                                    </div>
                                </a>
